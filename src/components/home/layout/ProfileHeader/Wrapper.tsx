...
export function Wrapper({ children }: PropsWithChildren) {
  ...
  return (
    <header className='flex flex-row w-full h-20 fixed lg:sticky top-0 justify-center lg:justify-end border-b border-light-border dark:border-dark-border bg-light-bg-hg dark:bg-dark-bg-hg z-10'>
