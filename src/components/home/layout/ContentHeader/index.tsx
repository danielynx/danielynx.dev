...
export function LayoutContentHeader({ children }: PropsWithChildren) {
  return (
    <header className='flex flex-col items-center lg:items-start justify-end w-full h-20 sticky top-16 lg:top-0 border-b bg-light-bg-hg dark:bg-dark-bg-hg border-light-border dark:border-dark-border'>
